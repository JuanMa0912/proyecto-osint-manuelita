...
- **Conflicto de datos financieros entre fuentes (a resolver por el equipo).** Los ingresos por año 2019–2022 **difieren** entre `data/structured/manuelita_datos.json` y el corpus markdown (p. ej. 2021: 1.819.755 vs 648.942 millones COP); solo 2023 coincide. La memoria semántica se cargó únicamente con el financiero **2023** para no propagar el conflicto, y las preguntas financieras de otros años deben tratarse con cautela hasta verificar la fuente autoritativa (reporte de Supersociedades).
