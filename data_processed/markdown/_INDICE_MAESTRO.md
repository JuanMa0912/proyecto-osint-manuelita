...
### 🏢 Web Oficial (1 documento)

| Archivo | Palabras | Método | Confianza | URL |
|---------|----------|--------|-----------|-----|
...
### 📄 PDFs Sostenibilidad (2 documentos)

| Archivo | Período | Páginas | Palabras | Tablas | Confianza |
|---------|---------|---------|----------|--------|-----------|
| [oficial_doc_manuelit.md](./oficial_doc_manuelit.md) | 2023–2024 | 146 | 17,687 | 21 | `0.97` |
| [oficial_pdf_sostenibilidad_manuelit.md](./oficial_pdf_sostenibilidad_manuelit.md) | 2021–2022 | 113 | 17,078 | 118 | `0.97` |

**Secciones detectadas:** `perfil_corporativo` · `gobierno_corporativo` · `sostenibilidad_economica` · `sostenibilidad_social` · `sostenibilidad_ambiental` · `gri` · `ods` · `carbono_neutralidad` · `biocombustibles` · `palma` · `azucar`

**Hallazgos clave:**
- Reducción emisiones Scope 1+2: **−6% en 2024** vs 2023
- Meta carbono: **−70% para 2030** → neutralidad en **2040**
- Familias beneficiadas 2023-2024: **+4,000**
- Aumento mujeres en operaciones: **+40%**

---

### 💼 LinkedIn (1 documento)

| Archivo | Seguidores | Método | Confianza |
|---------|-----------|--------|-----------|
| [red_social_linkedin_manuelit.md](./red_social_linkedin_manuelit.md) | 123,206 | verificado manualmente | `0.65` |

---

### 🎬 YouTube (1 documento)

| Archivo | API | Cuota usada | Confianza |
|---------|-----|-------------|-----------|
| [red_social_youtube_manuelit.md](./red_social_youtube_manuelit.md) | YouTube Data API v3 | ~204 / 10,000 unidades | `0.75` |

---

## Cobertura temática

| Tema | Documentos | Intensidad |
|------|-----------|-----------|
| `sostenibilidad_ambiental` | 3 | `████████████` Alta |
| `azucar_bioetanol` | 3 | `████████████` Alta |
| `palma_biodiesel` | 3 | `███████████░` Alta |
| `carbono_neutralidad` | 2 | `█████████░░░` Alta |
...
## Presencia geográfica documentada

| País | Operaciones |
|------|------------|
| 🇨🇴 Colombia | Azúcar (Valle del Cauca) · Palma (Meta, Casanare) · Acuicultura (Cartagena) |
| 🇵🇪 Perú | Agroindustrial Laredo — Azúcar (Trujillo) |
| 🇨🇱 Chile | Mejillones América — Acuicultura (Puerto Montt) |
